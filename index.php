		...
		//El método fetch_assoc trae la información del elemento de cada fila que queramos
					...
					if($found==false){
						...
						if($conexion->affected_rows >= 1){ 
							echo  "Hola ". $fila['Email'] . ' este usuario no se encuentra registrado<br />';
...
//									$_SESSION['nombre'] = 'Vane';
							...
							header('Location: signin.php' ); //Si el correo no se encuentra en la base de datos, te lleva a la pagina web de registro "signin.php"
						} 
					}
